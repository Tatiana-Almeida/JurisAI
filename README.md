...
- [PRECISA_VALIDAR] A revalidacao mais recente ainda nao encontrou `Access-Control-Allow-Origin` no runtime do backend Render, por isso o fetch do browser continua a falhar.
