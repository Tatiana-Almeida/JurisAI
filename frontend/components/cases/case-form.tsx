      ...
      <CardContent>
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <Select value={form.watch("lawyer_id")} onValueChange={(value) => form.setValue("lawyer_id", value)}>
              <SelectTrigger>
          ...
          <div className="space-y-2">
            <Label>Estado</Label>
            <Select value={form.watch("status")} onValueChange={(value) => form.setValue("status", value as CaseFormValues["status"])}>
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
