...
- A revalidacao mais recente ainda nao encontrou `Access-Control-Allow-Origin` no preflight de `/api/v1/auth/token/`, portanto o login real em browser continua bloqueado.
